...
<head>
     ...
     <link rel="stylesheet" href="appinfo.css">
               ...
               <div class="contents">
                    ...
                    <div class="info">
                         <div class="infocontent">
                              ...
                              <label for="office" class="valuelabel">Head Office Address:</label>
                    ...
                    <div class="navigation">
                         <a href="./home.html" class="navigate"><input type="button" value="Home" class="button"></a>
                    </div>
               </div>
          </form>
     </div>
